...
<html>
    ...
    <body style="background-color:#F5F2D0;">
        ...
        <h1 style="text-align:center;">Enter the Serial Number of the book to update that book.</h1>
        ...
        <form action="updateBook" method="post">
            <table>
                <tr>
                    ...
                    <th style="text-align:center;">NEW BOOK NAME:</th>
                    <th style="text-align:center;">NEW BOOK STOCK:</th>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <input type="text" name="newstock" required>
                    </td>
