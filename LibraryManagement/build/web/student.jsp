...
<html>
    ...
    <body style="background-color:lightgreen;">
       ...
       <ul class="secul">
            ...
            <li style="float:right"><a class="sec-li-a" href="student.jsp">Back to Library</a></li>
            <li style="float:right"><a class="sec-li-a" href="home.html">Home Page</a></li>
        </ul>
            
        <ul>
            <li><a class="active" href="student.jsp" style="font-size:30px;">Home</a></li>
            <li><a href="profile.jsp">View issued books</a></li>
